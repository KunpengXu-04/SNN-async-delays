...
# Never overwrite the manually maintained current deck.  Generated decks are
# inputs to an explicit review/merge step.
OUT_PATH = os.path.join(PRESENTATION_ROOT, "generated", "base_progress_report.pptx")
