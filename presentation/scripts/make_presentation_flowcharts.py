...
OUT_PATH = os.path.join(PRESENTATION_ROOT, "generated", "presentation_topology_flowcharts.pptx")
ROADMAP_IMG = os.path.join(PRESENTATION_ROOT, "assets", "topology 关系图.png")
