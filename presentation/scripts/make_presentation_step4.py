...
PROJECT_ROOT = os.path.dirname(PRESENTATION_ROOT)
SNN = os.path.join(PROJECT_ROOT, "snn_async_delays")
OUT_PATH = os.path.join(PRESENTATION_ROOT, "generated", "presentation_step4_update.pptx")
