...
const STEP4_PATH = path.join(PRESENTATION_ROOT, "generated", "presentation_step4_update.pptx");
const FLOW_PATH = path.join(PRESENTATION_ROOT, "generated", "presentation_topology_flowcharts.pptx");
const BACKUP_PATH = path.join(PRESENTATION_ROOT, "archive", "presentation_before_step4_merge_backup.pptx");
